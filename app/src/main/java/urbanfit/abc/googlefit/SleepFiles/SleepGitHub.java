...
public class SleepGitHub extends SleepActivityMainGithub {
    @Override
    ...
    private DataSet updateFitnessData() {
        ...
        DataPoint dataPoint = dataSet.createDataPoint()
                .setTimeInterval(startTime, endTime, TimeUnit.MILLISECONDS);
        dataPoint.getValue(Field.FIELD_SLEEP_SEGMENT_TYPE).setInt(stepCountDelta);
